...
export function MarketingBeforeAfter() {
  return (
    <section className="py-24 lg:py-32 bg-[var(--ink)] text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg font-medium text-[var(--ink-3)] max-w-2xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch max-w-5xl mx-auto">
          ...
          <div className="bg-white/5 border border-white/10 rounded-[28px] p-8 lg:p-12 flex flex-col justify-center">
            <h3 className="font-bold text-xl mb-8 text-[var(--ink-3)] uppercase tracking-wider font-mono">
              Before FlowStage
            </h3>
            <div className="space-y-6">
              {pains.map((pain, idx) => (
                <div key={idx} className="flex items-start gap-4 text-[var(--ink-3)] opacity-80">
          ...
          <div className="bg-[var(--surface)] border-2 border-[var(--lime)] rounded-[28px] p-8 lg:p-12 flex flex-col justify-center shadow-2xl shadow-[var(--lime)]/10 relative">
            <div className="absolute top-0 right-8 -translate-y-1/2">
              <span className="bg-[var(--lime)] text-[var(--ink)] font-bold px-4 py-1.5 rounded-full text-sm shadow-sm">
                The FlowStage Way
              </span>
            </div>
            <h3 className="font-bold text-xl mb-8 text-[var(--ink)] uppercase tracking-wider font-mono">
              After FlowStage
            </h3>
            <div className="space-y-6 mb-10">
              {reliefs.map((relief, idx) => (
                <div key={idx} className="flex items-start gap-4 text-[var(--ink)]">
            ...
            <Button asChild size="lg" className="w-full h-14 rounded-full font-bold bg-[var(--ink)] hover:bg-black text-white">
