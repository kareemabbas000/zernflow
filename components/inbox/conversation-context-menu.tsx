...
export function ConversationContextMenu({
  ...
  const posX = menuPosition.x + menuWidth > viewportWidth ? viewportWidth - menuWidth - 16 : menuPosition.x;
  const posY = menuPosition.y + menuHeight > viewportHeight ? viewportHeight - menuHeight - 16 : menuPosition.y;
  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-3 py-1.5 border-b border-border/50 text-[11px] font-bold text-foreground truncate flex items-center justify-between">
        ...
        <div className="py-1 space-y-0.5">
          ...
          <button
            ...
            className="flex w-full items-center gap-2.5 rounded-xl px-2.5 py-1.5 text-left text-foreground hover:bg-muted transition-colors"
          >
            {isUnread ? (
              <>
          ...
          {conversation.status === "open" ? (
            ...
            <button
              ...
              className="flex w-full items-center gap-2.5 rounded-xl px-2.5 py-1.5 text-left text-primary hover:bg-muted transition-colors"
            >
        ...
        <div className="py-1 space-y-0.5">
          ...
          <button
            ...
            className="flex w-full items-center justify-between rounded-xl px-2.5 py-1.5 text-left text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
          >
          ...
          <button
            ...
            className="flex w-full items-center gap-2.5 rounded-xl px-2.5 py-1.5 text-left text-rose-600 hover:bg-rose-500/10 transition-colors"
          >
