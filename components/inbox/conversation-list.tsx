...
export function ConversationList({
  ...
  return (
    <div className="flex h-full w-full max-w-full min-w-0 flex-col border-r border-[var(--border)] bg-[var(--paper)] select-none relative overflow-hidden">
      ...
      <div className="flex h-10 items-center justify-between border-b border-[var(--border)]/50 px-2 sm:px-3 bg-[var(--paper)] shrink-0 transition-all duration-200">
        {isBulkMode ? (
          <>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isSelected
                      ? "bg-primary/5 border-y border-l-4 border-r border-[var(--brand)] z-10 relative"
                      : isUnread
