    ...
    <div className="min-h-screen flex flex-col bg-[var(--bg)] text-[var(--text-primary)] font-sans selection:bg-[var(--brand)]/30">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        <div className="max-w-md mx-auto">
          ...
          <h1 className="font-display text-4xl font-black tracking-tight text-[var(--text-primary)] mb-4">
          ...
          <div className="flex items-center justify-center gap-4">
            <Button onClick={() => reset()} size="lg" className="rounded-full font-bold bg-[var(--text-primary)] text-[var(--bg)] hover:opacity-90 h-14 px-8">
