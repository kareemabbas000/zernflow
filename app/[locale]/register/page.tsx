    ...
    >
      <div className="space-y-6">
        <div className="w-full">
          <Button variant="outline" className="w-full h-12 rounded-xl font-bold border-[var(--border)]">
        ...
        <p className="text-center text-xs font-medium text-[var(--ink-3)] leading-relaxed mt-4">
          ...
          <Link href="/legal/terms-of-service" className="font-bold hover:text-[var(--ink)]">Terms of Service</Link>{" "}
          and{" "}
          <Link href="/legal/privacy-policy" className="font-bold hover:text-[var(--ink)]">Privacy Policy</Link>.
        </p>
