  ...
  return (
    <div className="pt-32 pb-24 bg-[var(--bg)] min-h-screen">
      <div className="max-w-3xl mx-auto px-6 lg:px-8 prose prose-slate">
        <h1 className="font-display text-4xl font-black text-[var(--text-primary)] mb-8">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
          ...
          <h2 className="font-bold text-2xl text-[var(--text-primary)] mt-8 mb-4">2. How We Use Your Information</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl text-[var(--text-primary)] mt-8 mb-4">3. Data Security & AI Processing</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl text-[var(--text-primary)] mt-8 mb-4">4. Contact Us</h2>
          <p>
