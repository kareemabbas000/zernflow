  ...
  return (
    <div className="pt-32 pb-24 bg-[var(--paper)] min-h-screen">
      <div className="max-w-3xl mx-auto px-6 lg:px-8 prose prose-slate">
        <h1 className="font-display text-4xl font-black text-[var(--ink)] mb-8">Terms of Service</h1>
        ...
        <div className="space-y-6 text-[var(--ink-2)] leading-relaxed">
          ...
          <h2 className="font-bold text-2xl text-[var(--ink)] mt-8 mb-4">1. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl text-[var(--ink)] mt-8 mb-4">2. Description of Service</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl text-[var(--ink)] mt-8 mb-4">3. User Responsibilities</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl text-[var(--ink)] mt-8 mb-4">4. API and Fair Usage</h2>
          <p>
          ...
          <h2 className="font-bold text-2xl text-[var(--ink)] mt-8 mb-4">5. Limitation of Liability</h2>
          <p>
